...
def peoplecounter():
    ...
    if add == 'People Counter':
        st.write("Use the camera input to start processing video.")
        camera_input = st.camera_input("Capture Video")
        ...
        if camera_input:
            ...
            while True:
                ...
                # Process the frame (resizing and YOLO prediction)
